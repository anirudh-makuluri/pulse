		...
		<div className="panel-page section-page">
			...
			{!settings ? (
				...
				<div className="section-content settings">
					...
					<section className="home-card settings-card flex flex-row justify-between w-full items-center">
						<div>
							<h3>Software update</h3>
							<p className="muted">Check GitHub Releases for a signed Pulse update and install it automatically.</p>
						</div>
						<div className="flex flex-col justify-end items-end">
							<Button className="primary border-none" onClick={onCheckForUpdates} disabled={checkingForUpdate}>
