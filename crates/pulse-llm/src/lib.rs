...
pub use embedding::HuggingFaceEmbeddingClient;
...
pub use types::{
    ...
    TaskCopilotAgentRequest, TaskCopilotOut, TaskCopilotRequest, TaskCopilotStep,
    TaskCopilotTask, TaskCopilotToolDefinition, TaskCopilotToolResult,
};
